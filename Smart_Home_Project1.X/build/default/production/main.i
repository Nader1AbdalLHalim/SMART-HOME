...
# 12 "./ECUL_MODULES/REAL_TIME_CLOCK_DS1307/RealTime_Clock.h"
...
# 16 "./ECUL_MODULES/TEMP_SENSOR_TC74/temp_sensor_tc74.h"
 ...
 void main(void)
{
    ...
    External_Eeprom_24c02c_WriteByte(0xA2,0x00, 0x06);
    _delay((unsigned long)((500)*(16000000/4000000.0)));
    External_Eeprom_24c02c_WriteByte(0xA6,0x00, 0x06);
    _delay((unsigned long)((500)*(16000000/4000000.0)));

    memory_val_1=External_Eeprom_24c02c_ReadByte(0xA2,0x00);
    memory_val_2=External_Eeprom_24c02c_ReadByte(0xA6,0x00);
    ...
    while (1)
    {
         ...
         read_temp= Temp_Sensor_Tc74_ReadByte( 0x9E );
